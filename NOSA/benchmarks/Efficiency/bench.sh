...
# Unified efficiency benchmark launcher.
#
# Usage:
#   bash bench.sh --model-path openbmb/NOSA-8B --seq-len 128K
#   bash bench.sh --model-path openbmb/NOSA-8B --no-offload -B 4 -L 16K
#   bash bench.sh --model-path openbmb/MiniCPM4.1-8B
#   bash bench.sh --model-path openbmb/MiniCPM4.1-8B --dense -B 4 -L 16K
#   bash bench.sh --model-path openbmb/MiniCPM4.1-8B --infinigen
#
# All arguments are forwarded to bench.py.
