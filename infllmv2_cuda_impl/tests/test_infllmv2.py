...
def test_flash_attn_varlen_block_output():
    fwd_pass, bwd_pass = _run_flash_attn_varlen_block_output(
        128, 128, 128, True, torch.bfloat16, 0, 1, 32, 2
    )
    assert fwd_pass
    assert bwd_pass

def _run_flash_attn_varlen_block_output(
...
if __name__ == "__main__":
    ...
    for config in test_configs:
        ...
        fwd_pass, bwd_pass = _run_flash_attn_varlen_block_output(*config)
