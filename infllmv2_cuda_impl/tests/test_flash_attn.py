...
pytest.importorskip("flash_attn", reason="flash-attn is required for FlashAttention reference tests")
...
_device_capability = torch.cuda.get_device_capability("cuda") if torch.cuda.is_available() else (0, 0)
...
if __name__ == "__main__":
    test_flash_attn_causal(1024, 1024, False, 128, False, torch.float16)
